#!/bin/bash
mysql -e "DROP DATABASE IF EXISTS TELCOMANAGER;"
mysql -e "CREATE DATABASE IF NOT EXISTS TELCOMANAGER;"
...
mysql TELCOMANAGER -e " INSERT INTO USER(USER_ID, NAME_USER)
	VALUES ('Cliente1', 'Anderson');
	INSERT INTO USER(USER_ID, NAME_USER)
	VALUES ('Cliente2', 'Soraya');
	INSERT INTO USER(USER_ID, NAME_USER)
	VALUES ('Cliente3', 'Ana Paula');"
mysql TELCOMANAGER -e " INSERT INTO FILE(NAME_FILE, SIZE, USER_ID)
